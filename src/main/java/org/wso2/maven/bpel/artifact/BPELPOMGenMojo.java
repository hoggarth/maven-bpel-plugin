...
/**
 * This is the Maven Mojo used for generating a pom for a BPEL artifact
 * from the old CApp project structure
 *
 * @goal pom-gen
 *
 */
public class BPELPOMGenMojo extends AbstractPOMGenMojo {
	...
	protected void copyResources(MavenProject project, File projectLocation, Artifact artifact)throws IOException {
		File bpelArtifact = artifact.getFile();
		FileUtils.copyFile(bpelArtifact, new File(projectLocation, bpelArtifact.getName()));
	}
	protected void addPlugins(MavenProject artifactMavenProject, Artifact artifact) {
		Plugin plugin = CAppMavenUtils.createPluginEntry(artifactMavenProject,"org.wso2.maven","maven-bpel-plugin","1.0.0",true);
